...
print("""\x1b[92m 
from pypynum import (arrays, geoms, hypcmpnms, logics, matrices, multiprec, polys, special, vectors, ciphers, consts, equations, maths, plotting, random, regs, tools, ufuncs) 
\x1b[m""")

print("...")

from . import (arrays, geoms, hypcmpnms, logics, matrices, multiprec, polys, special, vectors, ciphers, consts,
...
# multiprec 
print("""\x1b[92m 
mp_complex1 = multiprec.MPComplex("1.4142135623730950488016887242096980785696718753769", "2.7182818284590452353602874713527", sigfigs=30) 
mp_complex2 = multiprec.MPComplex("1.7320508075688772935274463415059", "3.141592653589793238462643383279502884197169399375105820974944", sigfigs=40) 
