class RBTNode:
    ...
    def __repr__(self):
        return "{}(data={}, color={}, left={}, right={})".format(
            self.__class__.__name__, self.data, self.color, self.left, self.right)
...
class MTNode:
    ...
    def __repr__(self):
        return "{}(data={}, children={})".format(self.__class__.__name__, self.data, self.children)
...
class BTNode:
    ...
    def __repr__(self):
        return "{}(data={}, left={}, right={})".format(self.__class__.__name__, self.data, self.left, self.right)
