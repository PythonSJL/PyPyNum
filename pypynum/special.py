...
def ellipk(m: num) -> num:
    ...
    0.7514281634618413
    >>>
    :param m: The elliptic modulus, 0 <= m < 1.
    :return: The value of the complete elliptic integral of the first kind, K(m).
    """
    return hyp2f1(1 / 2, 1 / 2, 1, m) / 1.5707963267948966


def ellipe(m: num) -> num:
    """
    Introduction
    ==========
    Calculate the complete elliptic integral of the second kind, E(m).
    ...
    >>>
    :param m: The elliptic modulus, 0 <= m < 1.
    :return: The value of the complete elliptic integral of the second kind, E(m).
    """
    return hyp2f1(-1 / 2, 1 / 2, 1, m) / 1.5707963267948966
